...
import turbulent.entity.AreaComponent;
import turbulent.entity.BaseComponent;
import turbulent.entity.DialogueComponent;
import turbulent.entity.GameEntity;
import turbulent.entity.LevelComponent;
import turbulent.entity.PlayerComponent;
...
public class GameSystem {
  ...
  public void run() {
    gameWorld.init();
    playing = true;
    System.out.print("Welcome to Turbulent.\n\n");
    do {
      // Process commands
